...
def iteration():
    ...
    population_sizes = [8,10] #种群大小

    # piece_nums = [10, 100, 1000]
    piece_nums = [100] #生产多少件
    ...
    for population_size, piece_num, Px, Pr in itertools.product(population_sizes, piece_nums, Px_values, Pr_values):
        ...
        result,pareto_front = main_2(data,staff_data,population_size,num_workstations,max_iterations,batch_time,elite_size,Px)
    ...
    df.to_excel("NSGA2_100_100_25_10.xlsx", index=False)

# 只有当脚本作为主程序运行时，才会执行以代码
